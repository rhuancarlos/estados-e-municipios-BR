...
-- Copiando estrutura para tabela bdestadocidade.ccloud_config_cidade
CREATE TABLE IF NOT EXISTS `ccloud_config_cidade` (
...
-- Copiando dados para a tabela bdestadocidade.ccloud_config_cidade: ~5.564 rows (aproximadamente)
/*!40000 ALTER TABLE `ccloud_config_cidade` DISABLE KEYS */;
INSERT INTO `ccloud_config_cidade` (`IDCIDADE`, `MUNICIPIO`, `IDESTADO`) VALUES
	(1, 'Afonso Cláudio', 8),
	...
	(5564, 'Xambioá', 27);
/*!40000 ALTER TABLE `ccloud_config_cidade` ENABLE KEYS */;

-- Copiando estrutura para tabela bdestadocidade.ccloud_config_estado
CREATE TABLE IF NOT EXISTS `ccloud_config_estado` (
  `IDESTADO` int(11) NOT NULL AUTO_INCREMENT,
  `ESTADO` varchar(75) DEFAULT NULL,
  `UD` varchar(5) DEFAULT NULL,
  `PAIS` int(7) DEFAULT NULL,
  PRIMARY KEY (`IDESTADO`),
  KEY `fk_Estado_pais` (`PAIS`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela bdestadocidade.ccloud_config_estado: ~27 rows (aproximadamente)
/*!40000 ALTER TABLE `ccloud_config_estado` DISABLE KEYS */;
INSERT INTO `ccloud_config_estado` (`IDESTADO`, `ESTADO`, `UD`, `PAIS`) VALUES
	(1, 'Acre', 'AC', 1),
	(2, 'Alagoas', 'AL', 1),
	(3, 'Amazonas', 'AM', 1),
	(4, 'Amapá', 'AP', 1),
	...
	(26, 'São Paulo', 'SP', 1),
	(27, 'Tocantins', 'TO', 1);
/*!40000 ALTER TABLE `ccloud_config_estado` ENABLE KEYS */;
